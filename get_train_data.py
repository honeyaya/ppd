...
all_bid_first['label'] = all_bid_first.backstate
all_bid_first.label = all_bid_first.label.apply(get_label)
...
t1 = all_bid_first[['listingId','shoudbackmoney']]
t1.groupby(['listingId']).agg('sum')
